...
<div class="group relative w-full" data-stable-select>
    <select
        name="{{ $name }}"
    ...
    <button
        ...
        aria-expanded="false"
        class="flex min-h-12 w-full items-center justify-between gap-3 rounded-xl border border-neutral-200 bg-white/95 px-4 py-3 text-left text-sm font-bold text-neutral-800 shadow-[0_14px_32px_-26px_rgba(15,23,42,0.75)] transition-all duration-200 hover:-translate-y-0.5 hover:border-emerald-200 hover:bg-white hover:shadow-[0_18px_36px_-26px_rgba(4,120,87,0.55)] focus:border-emerald-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
    >
        <span data-stable-select-label class="min-w-0 truncate">{{ $selectedLabel }}</span>
